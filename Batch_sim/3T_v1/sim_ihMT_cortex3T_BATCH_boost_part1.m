...
%% This can be broken into 3 scripts for numChunk, 1:16, 17:33, 34:50

tic
for i = 1:50 %numChunk, can use this to separate and run in separate scripts.
    stVal = st(i);
    edVal = ed(i);


    if ~isfile(strcat(DATADIR_INT,'Boost_dual_Signal_intermed_',num2str(i),'.mat'))
