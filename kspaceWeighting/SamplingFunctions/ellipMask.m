function A = ellipMask(r, dim, centerCoord)
...
%       Feb 3, 2012
%
% Usage:	A = ellipMask(r, [dim], [centerCoord]);
%	Input:    
...
%
% Examples:
%       A = ellipMask(35) will return a circle mask array with a circle of
%           radius 35. Default array size is 128x128 with a central 
%           location at the middle of the array
%
%       A = ellipMask([35 90], [800 600], [300 250]) will return an ellipse mask 
